...
-- функция перехода в visual mode
local function enter_visual_mode()
	local keys = bind.escape_termcode("<Esc>v")
	vim.api.nvim_feedkeys(keys, "n", false)
end

-- insert mode jj/jk → normal mode
local insert_mappings = {
	["i|jj"] = bind.map_cmd("<Esc>"):with_noremap():with_silent(),
	["i|jk"] = bind.map_cmd("<Esc>"):with_noremap():with_silent(),
}

bind.nvim_load_mapping(insert_mappings)
