...
local mappings = {
	plugins = {
		...
		-- Plugin: gradle
		["n|<leader>Gg"] = map_cr("Gradle"):with_noremap():with_silent():with_desc("gradle: Projects"),
		["n|<leader>Gf"] = map_cr("GradleFavorites")
			:with_noremap()
			:with_silent()
			:with_desc("gradle: Favorite commands"),
		["n|<leader>Ge"] = map_cr("GradleExec"):with_noremap():with_silent():with_desc("gradle: Execute task"),

		-- Plugin: telescope-file-browser
		["n|<leader>e"] = map_cu("Telescope file_browser path=%:p:h select_buffer=true"):with_noremap():with_silent():with_desc("filebrowser: Toggle"),
		...
		-- Plugin: logs
		["n|<leader>ll"] = map_cr("Lazy log"):with_noremap():with_silent():with_desc("log: Lazy plugin logs"),
		["n|<leader>ln"] = map_cr("edit " .. vim.fn.stdpath("state") .. "/lsp.log")
			:with_noremap()
			:with_silent()
			:with_desc("log: LSP log"),
		...
		["n|<leader>fR"] = map_callback(function()
			...
			:with_silent()
			:with_desc("tool: Resume last search"),
		["n|<leader>th"] = map_cr("Telescope colorscheme")
			:with_noremap()
			:with_silent()
			:with_desc("theme: Switch colorscheme"),
