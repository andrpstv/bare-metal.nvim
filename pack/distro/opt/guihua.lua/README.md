...
- `vim.ui.input()` uses a window title for short prompts: explicit `title` wins, otherwise the first prompt line is used; long or multiline prompts render inside the popup body instead of being clipped in the title bar.
